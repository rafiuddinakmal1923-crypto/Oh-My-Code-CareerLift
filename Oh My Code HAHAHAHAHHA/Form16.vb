...
Public Class Form16
    ...
    Private Sub btnSignUp_Click(sender As Object, e As EventArgs) Handles btnSignUp.Click
        ...
        If rdoJobSeeker.Checked Then
            userType = "JobSeeker"
            Signindata(username, password, userType)
    ...
    Private Sub Signindata(ByRef username As String, ByRef password As String, ByRef userType As String)
    ...
    Private Sub LinkLabel3_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles lnllblLogin.LinkClicked
        Me.Hide()
        Form4.Show()
    End Sub
